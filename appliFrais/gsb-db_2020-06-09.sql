...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mar. 09 juin 2020 à 18:25
...
('a17', '201810', 0, NULL, '2020-04-19', 'CL'),
('a17', '202004', 0, NULL, '2020-05-09', 'CL'),
('a17', '202005', 0, NULL, '2020-05-09', 'CR'),
('z1', '202004', 0, NULL, '2020-06-09', 'CL'),
('z1', '202006', 0, NULL, '2020-06-09', 'CR'),
('z12', '201911', 0, NULL, '2020-06-09', 'CL'),
('z12', '202006', 0, NULL, '2020-06-09', 'CR'),
('z121', '201911', 0, NULL, '2020-04-19', 'CL'),
('z121', '202004', 0, NULL, '2020-06-08', 'CL'),
('z121', '202006', 0, NULL, '2020-06-08', 'CR');
...
CREATE TABLE `lignefraisforfait` (
  ...
  `idLigneFraisForfait` char(5) NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `lignefraisforfait` (`idVisiteur`, `mois`, `idFraisForfait`, `quantite`, `idLigneFraisForfait`) VALUES
('a17', '201810', 'ETP', 0, ''),
('a17', '201810', 'KM', 0, ''),
('a17', '201810', 'NUI', 0, ''),
('a17', '201810', 'REP', 0, ''),
...
(2, 'z1', '202006', 'objet admin', '2020-06-09', '500.00'),
(3, 'z12', '202006', 'objet comptable', '2020-06-08', '250.00'),
(4, 'z121', '202006', 'objet visiteur medical', '2020-06-07', '100.00');
...
('z1', 'admin', 'admin', 'admin', 'root', NULL, NULL, NULL, NULL, 1),
('z12', 'Naimar', 'Jean', 'jnaimar', 'teste1', 'rue', '00000', 'ville', '2019-11-03', 3),
('z121', 'Rogne', 'Yves', 'Yrogne', 'teste2', 'a', 'a', 'a', '2019-11-19', 2);
...
ALTER TABLE `lignefraisforfait`
  ADD KEY `lignefraisforfait_ibfk_1` (`idVisiteur`,`mois`),
  ADD KEY `lignefraisforfait_ibfk_2` (`idFraisForfait`);
...
--
ALTER TABLE `visiteur`
  ADD CONSTRAINT `visiteur_ibfk_1` FOREIGN KEY (`role`) REFERENCES `role` (`idRole`);
COMMIT;
